...
const supabaseUrl = Deno.env.get("KAMEPOSU_DATABASE_URL");
const serviceRoleKey = Deno.env.get("KAMEPOSU_SERVICE_ROLE_KEY");

if (!supabaseUrl || !serviceRoleKey) {
  throw new Error("KAMEPOSU_DATABASE_URL and KAMEPOSU_SERVICE_ROLE_KEY are required.");
}
